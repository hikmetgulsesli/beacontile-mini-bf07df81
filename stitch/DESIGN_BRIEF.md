...
- BeaconTile Mini turns the user's request into a directly usable web workflow. The first experience must be the actual web product behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a tiny single-page utility called BeaconTile Mini. It should show three status tiles, let the user toggle each tile between ok/warn/down, persist state in localStorage, expose window.app with getState and reset methods, and include visible controls for reset and export.
...
- Record Operations - BeaconTile Mini
- Record Editor - BeaconTile Mini
- Insights - BeaconTile Mini

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Record Operations - BeaconTile Mini
...
SCREEN_SPEC_2:
- exact_screen_title: Record Editor - BeaconTile Mini
...
SCREEN_SPEC_3:
- exact_screen_title: Insights - BeaconTile Mini
